...
public class CombatService {
    ...
    private static final int COMBAT_EXPIRATION_MINUTES = 30;
    private static final int INITIAL_HEALTH = 100;
    private static final int INITIAL_ACTION_POINTS = 2;
    ...
    public Combat getCombat(String combatId) {
        return combatRepository.findById(combatId).get();
    }
    ...
    private Action generateAIAction(Combat combat, String aiPlayerId) {
        ...
        return new Action(aiPlayerId, actionType, targetId, 1);  // Assuming all actions cost 1 AP for simplicity
    }
    ...
    private void performSpell(Combat combat, Action action) {
        int effect = calculateDamage(action.getPlayerId(), 5, 25);
        // Implement spell effects (could be damage, healing, buffs, etc.)
    }
